public class ItemCodex{
	...
	String[] specialWeapons = {"stick","spear","halberd","","fallen blade","end of night","edge of chaos","sword of the dweller","undying blade","blackDeath","deathSythe","sword of the mad god","Excalibur",,"god mode"};
	String[] rngXTRA materials ={"iron","steel","mithril",);
	...
	public void weapon(){
		...
		else if(wm>90){weapon.mat = 14;weapon.matMult= 4;}//ancient r
		else if(wm>85){weapon.mat = 13;weapon.matMult= 3;}//enchanted r
		...
		else if(wm>55){weapon.mat = 8;weapon.matMult=5;}//ancient m
		else if(wm>50){weapon.mat = 7;weapon.matMult=4;}//enchanted m
		...
		else if(wm>25){weapon.mat = 2;weapon.matMult=1;}//iron 
		else if(wm>20){weapon.mat = 1;weapon.matMult=0.5;} //copper
		...
		//special[]
			if(td > 99){weapon.type=12;weapon.diceno=40;weapon.diceMax=999;}//godmode max dmg = 9999 (dmg%9999)
			else if(td > 97){weapon.type=11;weapon.diceno=14;weapon.diceMax=200;}//Excalibur dmg=2800
			else if(td > 95){weapon.type=5;weapon.diceno=10;weapon.diceMax=250;}//sword of the mad god MD = 2500
			...
			else if(td > 50){weapon.type=3;weapon.diceno=8;weapon.diceMax=150;}//  MD = 2000
